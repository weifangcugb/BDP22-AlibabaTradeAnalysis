 ...
 * 日交易额商家排行
 */
function getOptionContent0(title, titles, uvs) {
    var option = {
        title: {
            text: title,
            textStyle: {
        ...
        series: [
            {
                ...
                itemStyle: {
                    normal: {
                        color: function(params) {
                            var colorList = [
                                '#C1232B','#FCCE10','#27727B','#F4E001',
                                '#D7504B','#C6E579','#E87C25','#F0805A','#26C0C0','#B5C334',
                            ];
                            if(params.dataIndex < 0) {
                                return colorList[0];
                            }
 ...
 * 奶茶排行
 */
function getOptionContent1(title, titles, uvs) {
    var option = {
        title: {
            text: title,
            textStyle: {
 ...
 * 中式快餐排行
 */
function getOptionContent2(title, titles, uvs) {
    var option = {
        title: {
            text: title,
            textStyle: {
